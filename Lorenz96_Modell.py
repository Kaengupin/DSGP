...
os.chdir("/data/share/lehre/unix/edvprak/u301027/DSGP_NEU")
...
# open files to save
fX = tables.open_file(title1 + "_" + scheme + "_" + "Pert_" + str(PERT) +'.h5', mode='w')
fY = tables.open_file(title2 +'.h5', mode='w')
